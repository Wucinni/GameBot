...
def set_npc_location():
    ...
    tk.messagebox.showinfo(message=f"Location set.")
    print(npc_location)
...
def main():
    ...
    npc_image = tk.PhotoImage(file=path[:len(path)-len(file_name)] + "assets\\mouse_icon.png")
